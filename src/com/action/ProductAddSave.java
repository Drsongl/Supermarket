...
public class ProductAddSave extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		{
			out.print("<script language='javascript'>alert('请输入合理的商品价格');history.back(-1);</script>");
			out.flush();out.close();return null;
		}
		...
		//��ת
		out.print("<script language='javascript'>alert('成功添加商品');window.location='ProductManager.action';</script>");
		out.flush();out.close();return null;
